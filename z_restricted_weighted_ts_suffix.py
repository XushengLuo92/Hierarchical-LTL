...
def construct_node_set(poset, element2edge, pruned_subgraph, type_robot_label, minimal_element):
    """
    ...
    for element in poset:
        ...
        node_index = construct_node_set_helper(element, 1, edge_label, element_component_clause_literal_node,
                                               ...
                                               type_robot_label, final_element_type_robot_node)
        # with self loop
...
def construct_node_set_helper(element, component, label, element_component_clause_literal_node,
    ...
    # didn't explictly create the extra clause for the literal
...
def construct_edge_set(poset, element_component_clause_literal_node, element2edge, pruned_subgraph,
    ...
    for element in poset:
        ...
        if element in minimal_element:
            construct_edge_set_minimal_helper(element, 1, element_component2label,
                                              element_component_clause_literal_node,
                                              init_type_robot_node, incmp_large_element, edge_set,
...
def construct_edge_set_minimal_helper(element, component, element_component2label, element_component_clause_literal_node,
                                      init_type_robot_node, incmp_element, edge_set, final_element_type_robot_node):
    """
