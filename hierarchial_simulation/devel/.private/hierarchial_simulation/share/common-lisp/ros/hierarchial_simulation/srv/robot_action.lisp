...
(cl:defmethod cl:initialize-instance :after ((m <robot_action-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_action-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hierarchial_simulation-srv:<robot_action-request> is deprecated: use hierarchial_simulation-srv:robot_action-request instead.")))

(cl:ensure-generic-function 'des-val :lambda-list '(m))
(cl:defmethod des-val ((m <robot_action-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hierarchial_simulation-srv:des-val is deprecated.  Use hierarchial_simulation-srv:des instead.")
  (des m))

(cl:ensure-generic-function 'src-val :lambda-list '(m))
(cl:defmethod src-val ((m <robot_action-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hierarchial_simulation-srv:src-val is deprecated.  Use hierarchial_simulation-srv:src instead.")
  (src m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_action-request>)))
  ...
  "hierarchial_simulation/robot_actionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_action-request)))
  "Returns string type for a service object of type 'robot_action-request"
  "hierarchial_simulation/robot_actionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <robot_action-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_action-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hierarchial_simulation-srv:<robot_action-response> is deprecated: use hierarchial_simulation-srv:robot_action-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_action-response>)))
  ...
  "hierarchial_simulation/robot_actionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_action-response)))
  "Returns string type for a service object of type 'robot_action-response"
  "hierarchial_simulation/robot_actionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_action)))
  ...
  "hierarchial_simulation/robot_action")