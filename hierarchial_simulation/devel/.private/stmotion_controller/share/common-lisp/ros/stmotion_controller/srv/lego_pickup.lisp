...
(cl:in-package stmotion_controller-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <lego_pickup-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lego_pickup-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stmotion_controller-srv:<lego_pickup-request> is deprecated: use stmotion_controller-srv:lego_pickup-request instead.")))

(cl:ensure-generic-function 'reference_frame-val :lambda-list '(m))
(cl:defmethod reference_frame-val ((m <lego_pickup-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stmotion_controller-srv:reference_frame-val is deprecated.  Use stmotion_controller-srv:reference_frame instead.")
  (reference_frame m))

(cl:ensure-generic-function 'is_pick-val :lambda-list '(m))
(cl:defmethod is_pick-val ((m <lego_pickup-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stmotion_controller-srv:is_pick-val is deprecated.  Use stmotion_controller-srv:is_pick instead.")
  (is_pick m))

(cl:ensure-generic-function 'pick_lego_name-val :lambda-list '(m))
(cl:defmethod pick_lego_name-val ((m <lego_pickup-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stmotion_controller-srv:pick_lego_name-val is deprecated.  Use stmotion_controller-srv:pick_lego_name instead.")
  (pick_lego_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lego_pickup-request>)))
  ...
  "stmotion_controller/lego_pickupRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lego_pickup-request)))
  "Returns string type for a service object of type 'lego_pickup-request"
  "stmotion_controller/lego_pickupRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <lego_pickup-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lego_pickup-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stmotion_controller-srv:<lego_pickup-response> is deprecated: use stmotion_controller-srv:lego_pickup-response instead.")))

(cl:ensure-generic-function 'finished-val :lambda-list '(m))
(cl:defmethod finished-val ((m <lego_pickup-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stmotion_controller-srv:finished-val is deprecated.  Use stmotion_controller-srv:finished instead.")
  (finished m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lego_pickup-response>)))
  ...
  "stmotion_controller/lego_pickupResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lego_pickup-response)))
  "Returns string type for a service object of type 'lego_pickup-response"
  "stmotion_controller/lego_pickupResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lego_pickup)))
  ...
  "stmotion_controller/lego_pickup")