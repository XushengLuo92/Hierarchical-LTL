...
(cl:in-package moveit_fanuc_config-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <robot_action-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_action-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_fanuc_config-srv:<robot_action-request> is deprecated: use moveit_fanuc_config-srv:robot_action-request instead.")))

(cl:ensure-generic-function 'des-val :lambda-list '(m))
(cl:defmethod des-val ((m <robot_action-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_fanuc_config-srv:des-val is deprecated.  Use moveit_fanuc_config-srv:des instead.")
  (des m))

(cl:ensure-generic-function 'src-val :lambda-list '(m))
(cl:defmethod src-val ((m <robot_action-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_fanuc_config-srv:src-val is deprecated.  Use moveit_fanuc_config-srv:src instead.")
  (src m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_action-request>)))
  ...
  "moveit_fanuc_config/robot_actionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_action-request)))
  "Returns string type for a service object of type 'robot_action-request"
  "moveit_fanuc_config/robot_actionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <robot_action-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_action-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_fanuc_config-srv:<robot_action-response> is deprecated: use moveit_fanuc_config-srv:robot_action-response instead.")))

(cl:ensure-generic-function 'finished-val :lambda-list '(m))
(cl:defmethod finished-val ((m <robot_action-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_fanuc_config-srv:finished-val is deprecated.  Use moveit_fanuc_config-srv:finished instead.")
  (finished m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_action-response>)))
  ...
  "moveit_fanuc_config/robot_actionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_action-response)))
  "Returns string type for a service object of type 'robot_action-response"
  "moveit_fanuc_config/robot_actionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_action)))
  ...
  "moveit_fanuc_config/robot_action")