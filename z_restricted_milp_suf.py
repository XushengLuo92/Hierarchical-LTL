...
def construct_milp_constraint(ts, type_num, poset, pruned_subgraph, element2edge, element_component_clause_literal_node,
    ...
    m = Model()
    # create variables
    x_vars, t_vars, c_vars, t_edge_vars, b_element_vars, b_minimal_element_vars\
        = create_variables(m, ts, poset, pruned_subgraph, element2edge, type_num, minimal_element)
