...
def construct_edge_set(poset, element_component_clause_literal_node, element2edge, pruned_subgraph,
                       element_component2label, init_type_robot_node, incomparable_element,
                       strict_larger_element, larger_element, imply):
    """
...
def construct_edge_set_for_edge_helper(element, element_component2label,
                                       element_component_clause_literal_node,
